...
public class AStar {
    ...
    public static void setBlocked(int row, int j){
        grid[row][j] = null;
    }
    
    public static void setStartCell(int row, int j){
        startI = row;
        startJ = j;
    }
    
    public static void setEndCell(int row, int j){
        endI = row;
        endJ = j; 
    }
    
    static void checkAndUpdateCost(Cell current, Cell t, int cost){
        if(t == null || closed[t.row][t.col])return;
